...
def create_report(self):
    ...
    all_results, mismatch_counts = desigresult.check_desig_status(self)
    ...
    for xml_file in cleanup_counts.keys():
        ...
        with open(report_file_path, "w", encoding='utf-8') as report_file:
            ...
            report_file.write("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n") 
            report_file.write(f"Core desig mismatch: {mismatch_counts[xml_file]}\n")
            report_file.write("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")             
            report_file.write(f"Check desig: {all_results[xml_file]}\n")
            report_file.write("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")                      
